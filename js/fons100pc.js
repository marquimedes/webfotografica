...
/*FONS ALEATORI*/{
	...
	iBase.style.filter = "grayscale(100%) brightness(50%)";
		/*Hem escrit:{
			<div class="fons">
				<img class="imgNova" src="..." style="filter: grayscale(100%) brightness(50%); display: none;">
				...
				<img class="imgNova" src="..." style="filter: grayscale(100%) brightness(50%); display: none;">
				<img class="imgBase" src="?" style="filter: grayscale(100%) brightness(50%);">
			</div>
		}*/
