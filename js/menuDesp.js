...
menu.appendChild(lateral);
	...
	lateral.appendChild(apartats);
		...
		apartat.innerHTML = "<a href='inici.html'>INICI</a>";
		//Espai
		...
		apartat2.innerHTML = "<a href='https://www.instagram.com/marc.alma/?hl=es' target='_blank'>" +
						...
						"<a href='#'><img src='img/icones/profile.png'></a>";
...
document.getElementsByClassName("menuSubaps")[0].children[3].href = "albumCorrefoc.html"
document.getElementsByClassName("menuSubaps")[0].children[4].href = "albumPlaca.html"
