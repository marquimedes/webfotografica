//Per canviar les fotos que mostra la galeria, només cal editar el vector "imgs" de GALERIA i el numero del "for"

//Poden funcionar les fletxes per passar fotots??? i Esc per sortir de diapositiva??

/*GALERIA*/{
	var imgs = [
		"img/albums/albumMontperdut/01.jpg",
		"img/albums/albumMontperdut/02.jpg",
		"img/albums/albumMontperdut/03.jpg",
		"img/albums/albumMontperdut/04.jpg",
		"img/albums/albumMontperdut/05.jpg",
		"img/albums/albumMontperdut/06.jpg",
		"img/albums/albumMontperdut/07.jpg",
		"img/albums/albumMontperdut/08.jpg",
		"img/albums/albumMontperdut/09.jpg"
		]
	for(j=10; j<52; j++){
		imgs.push("img/albums/albumMontperdut/" + j + ".jpg");}
