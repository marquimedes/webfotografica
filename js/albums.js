...
//FINESTRA EN HOVER ALBUM CORREFOC
{
	...
	var correfoc = document.getElementsByClassName("menu")[0].children[2];//child[3]=correfoc
...
//FINESTRA EN HOVER ALBUM PLACA
{
	...
	var placa = document.getElementsByClassName("menu")[0].children[3];//child[X]=Placa
